...
var simpleGallery_navpanel={
    loadinggif: 'images/slider/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: ['images/slider/left.gif', 'images/slider/play.gif', 'images/slider/right.gif', 'images/slider/pause.gif'], //nav panel images (in that order)
